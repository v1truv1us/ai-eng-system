...
The ai-eng-system is an advanced development toolkit with context engineering, research orchestration, and 32 specialized agents for Claude Code & OpenCode.
...
✅ **32 Specialized Agents**: Across architecture, development, quality, devops, AI/ML, content, and plugin development
...
| 5. Review | `/ai-eng/review` | Multi-perspective code review (32 agents) |
