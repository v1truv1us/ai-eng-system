...
description: Instinct-based learning system with confidence scoring,
  import/export, and evolution into skills. The system learns patterns from
  sessions and promotes high-confidence instincts into durable skills. Use when
  extracting patterns from completed work.
---
