...
**Deliverables**:
- `/ai-eng/plan` command works
- `/ai-eng/work` command works
- `/ai-eng/review` command works
...
<parameter name="filePath">/home/vitruvius/git/ai-eng-system/plans/2025-01-01-phase1.md