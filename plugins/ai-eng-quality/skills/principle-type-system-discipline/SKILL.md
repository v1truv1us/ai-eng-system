...
description: Apply when designing types or signatures in a statically-typed language. Make illegal states unrepresentable; brand primitives; parse at boundaries; exhaust variants.
metadata:
