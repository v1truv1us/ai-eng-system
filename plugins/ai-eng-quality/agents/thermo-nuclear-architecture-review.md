...
description: Thermo-nuclear architecture audit (coupling, boundary violations, dependency direction, layering, structural decay). Invoked via Task after a parent gathers diff and file contents. Loads the rubric from the `thermo-nuclear-architecture-review` skill.
mode: subagent
temperature: 0.1
tools:
  read: true
