---
name: review
description: Read-only multi-axis review orchestrator. Dispatches specialist
  subagents (code-reviewer, security-scanner, architect-advisor,
  performance-engineer) via the Task tool and synthesizes their findings into
  one prioritized report. Use PROACTIVELY for /review and /deep-review.
mode: subagent
