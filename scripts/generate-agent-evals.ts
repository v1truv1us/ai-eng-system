...
function generateEvals(agentName: string, frontmatter: Record<string, any>, body: string): EvalFile {
  ...
  const hasCapabilities = body.includes("Capabilities") || body.includes("capabilities");
...
async function main(): Promise<void> {
  ...
  for (const file of agentFiles) {
    ...
    const evalsDir = join(agentsDir, "..", "..", "evals", "agents", agentName);
