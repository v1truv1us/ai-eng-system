...
description: "Write a structured specification before code: objectives, structure, code style, testing strategy, boundaries. Use when starting a new project or feature."
metadata:
